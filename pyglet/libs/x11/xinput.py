...
# /usr/include/X11/extensions/XInput.h:5045
XDeviceKeyPressedEvent = XDeviceKeyEvent
# /usr/include/X11/extensions/XInput.h:5046
...
# /usr/include/X11/extensions/XInput.h:5075
XDeviceButtonEvent = struct_anon_95
# /usr/include/X11/extensions/XInput.h:5077
XDeviceButtonPressedEvent = XDeviceButtonEvent
# /usr/include/X11/extensions/XInput.h:5078
...
# /usr/include/X11/extensions/XInput.h:5108
...
# /usr/include/X11/extensions/XInput.h:5133
XDeviceFocusChangeEvent = struct_anon_97
# /usr/include/X11/extensions/XInput.h:5135
XDeviceFocusInEvent = XDeviceFocusChangeEvent
# /usr/include/X11/extensions/XInput.h:5136
...
# /usr/include/X11/extensions/XInput.h:5164
XProximityNotifyEvent = struct_anon_98
# /usr/include/X11/extensions/XInput.h:5165
XProximityInEvent = XProximityNotifyEvent
# /usr/include/X11/extensions/XInput.h:5166
...
# /usr/include/X11/extensions/XInput.h:5195
...
# /usr/include/X11/extensions/XInput.h:5250
...
# /usr/include/X11/extensions/XInput.h:5268
...
# /usr/include/X11/extensions/XInput.h:5293
...
# /usr/include/X11/extensions/XInput.h:5328
...
# /usr/include/X11/extensions/XInput.h:5341
...
# /usr/include/X11/extensions/XInput.h:5354
...
# /usr/include/X11/extensions/XInput.h:5367
...
# /usr/include/X11/extensions/XInput.h:5380
...
# /usr/include/X11/extensions/XInput.h:5392
...
# /usr/include/X11/extensions/XInput.h:5415
...
# /usr/include/X11/extensions/XInput.h:5433
...
# /usr/include/X11/extensions/XInput.h:5445
...
# /usr/include/X11/extensions/XInput.h:5456
...
# /usr/include/X11/extensions/XInput.h:5469
...
# /usr/include/X11/extensions/XInput.h:5481
...
# /usr/include/X11/extensions/XInput.h:5500
...
# /usr/include/X11/extensions/XInput.h:5509
...
# /usr/include/X11/extensions/XInput.h:5522
...
# /usr/include/X11/extensions/XInput.h:5533
...
# /usr/include/X11/extensions/XInput.h:5539
...
# /usr/include/X11/extensions/XInput.h:5552
...
# /usr/include/X11/extensions/XInput.h:5573
...
# /usr/include/X11/extensions/XInput.h:5587
...
# /usr/include/X11/extensions/XInput.h:5614
...
# /usr/include/X11/extensions/XInput.h:5636
...
XChangePointerDevice.argtypes = [
    POINTER(Display), POINTER(XDevice), c_int, c_int]

# /usr/include/X11/extensions/XInput.h:5766
XGrabDevice = _lib.XGrabDevice
XGrabDevice.restype = c_int
XGrabDevice.argtypes = [POINTER(Display), POINTER(
    XDevice), Window, c_int, c_int, POINTER(XEventClass), c_int, c_int, Time]
...
XGrabDeviceKey.argtypes = [POINTER(Display), POINTER(XDevice), c_uint, c_uint, POINTER(
    XDevice), Window, c_int, c_uint, POINTER(XEventClass), c_int, c_int]
...
XUngrabDeviceKey.argtypes = [
    POINTER(Display), POINTER(XDevice), c_uint, c_uint, POINTER(XDevice), Window]

# /usr/include/X11/extensions/XInput.h:5807
XGrabDeviceButton = _lib.XGrabDeviceButton
XGrabDeviceButton.restype = c_int
XGrabDeviceButton.argtypes = [POINTER(Display), POINTER(XDevice), c_uint, c_uint, POINTER(
    XDevice), Window, c_int, c_uint, POINTER(XEventClass), c_int, c_int]
...
XGetDeviceFocus.argtypes = [POINTER(Display), POINTER(
    XDevice), POINTER(Window), POINTER(c_int), POINTER(Time)]

# /usr/include/X11/extensions/XInput.h:5845
XSetDeviceFocus = _lib.XSetDeviceFocus
XSetDeviceFocus.restype = c_int
XSetDeviceFocus.argtypes = [
    POINTER(Display), POINTER(XDevice), Window, c_int, Time]
...
XGetFeedbackControl.argtypes = [
    POINTER(Display), POINTER(XDevice), POINTER(c_int)]
...
XChangeFeedbackControl.argtypes = [
    POINTER(Display), POINTER(XDevice), c_ulong, POINTER(XFeedbackControl)]
...
XGetDeviceKeyMapping.argtypes = [
    POINTER(Display), POINTER(XDevice), KeyCode, c_int, POINTER(c_int)]
...
XChangeDeviceKeyMapping.argtypes = [
    POINTER(Display), POINTER(XDevice), c_int, c_int, POINTER(KeySym), c_int]
...
XSetDeviceModifierMapping.argtypes = [
    POINTER(Display), POINTER(XDevice), POINTER(XModifierKeymap)]
...
XSetDeviceButtonMapping.argtypes = [
    POINTER(Display), POINTER(XDevice), POINTER(c_ubyte), c_int]
...
XGetDeviceButtonMapping.argtypes = [
    POINTER(Display), POINTER(XDevice), POINTER(c_ubyte), c_uint]
...
XSetDeviceValuators.argtypes = [
    POINTER(Display), POINTER(XDevice), POINTER(c_int), c_int, c_int]
...
XChangeDeviceControl.argtypes = [
    POINTER(Display), POINTER(XDevice), c_int, POINTER(XDeviceControl)]
...
XSelectExtensionEvent.argtypes = [
    POINTER(Display), Window, POINTER(XEventClass), c_int]
...
XGetSelectedExtensionEvents.argtypes = [POINTER(Display), Window, POINTER(
    c_int), POINTER(POINTER(XEventClass)), POINTER(c_int), POINTER(POINTER(XEventClass))]
...
XChangeDeviceDontPropagateList.argtypes = [
    POINTER(Display), Window, c_int, POINTER(XEventClass), c_int]
...
XGetDeviceDontPropagateList.argtypes = [
    POINTER(Display), Window, POINTER(c_int)]
...
XSendExtensionEvent.argtypes = [POINTER(Display), POINTER(
    XDevice), Window, c_int, c_int, POINTER(XEventClass), POINTER(XEvent)]
...
XGetDeviceMotionEvents.argtypes = [POINTER(Display), POINTER(
    XDevice), Time, Time, POINTER(c_int), POINTER(c_int), POINTER(c_int)]
