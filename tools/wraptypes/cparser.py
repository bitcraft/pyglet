...
def p_unary_expression(p):
    ...
    if len(p) == 2:
        ...
        # TODO: INC_OP and DEC_OP expression nodes not supported
        p[0] = p[2]
...
def p_assignment_expression(p):
    ...
    if len(p) == 2:
        ...
        # TODO: assignment expression node not supported
        p[0] = p[3]
...
def p_expression(p):
    ...
    """
    p[0] = p[1]
    # TODO: sequence expression node not supported
...
def p_specifier_qualifier_list(p):
    """specifier_qualifier_list : type_specifier specifier_qualifier_list
                                ...
                                | type_qualifier
    """
    # TODO: Interesting.. why is this one right-recursion?
    if len(p) == 3:
        p[0] = (p[1],) + p[2]
    else:
        p[0] = (p[1],)
        ...
        def handle_status(self, message):
            ...
            def impl_handle_declaration(self, declaration, filename, lineno):
                ...
                if declaration.storage == 'typedef':
                    ...
                    if not declarator:
                        # TODO: TEMPORARY while struct etc not filled
                        return
