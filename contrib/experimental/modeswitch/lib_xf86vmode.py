...
XF86VidModeQueryVersion.argtypes = [POINTER(Display), POINTER(c_int),
                                    POINTER(c_int)]

# xf86vmode.h:187
XF86VidModeQueryExtension = _lib.XF86VidModeQueryExtension
XF86VidModeQueryExtension.restype = Bool
XF86VidModeQueryExtension.argtypes = [POINTER(Display), POINTER(c_int),
                                      POINTER(c_int)]
...
XF86VidModeGetModeLine.argtypes = [POINTER(Display), c_int, POINTER(c_int),
...
XF86VidModeGetAllModeLines.argtypes = [POINTER(Display), c_int, POINTER(c_int),
                                       POINTER(POINTER(
...
XF86VidModeAddModeLine.argtypes = [POINTER(Display), c_int,
                                   POINTER(XF86VidModeModeInfo),
                                   POINTER(XF86VidModeModeInfo)]
...
XF86VidModeSwitchToMode.argtypes = [POINTER(Display), c_int,
                                    POINTER(XF86VidModeModeInfo)]
...
XF86VidModeGetMonitor.argtypes = [POINTER(Display), c_int,
                                  POINTER(XF86VidModeMonitor)]

# xf86vmode.h:260
XF86VidModeGetViewPort = _lib.XF86VidModeGetViewPort
XF86VidModeGetViewPort.restype = Bool
XF86VidModeGetViewPort.argtypes = [POINTER(Display), c_int, POINTER(c_int),
                                   POINTER(c_int)]
...
XF86VidModeGetDotClocks.argtypes = [POINTER(Display), c_int, POINTER(c_int),
...
XF86VidModeGetGamma.argtypes = [POINTER(Display), c_int,
                                POINTER(XF86VidModeGamma)]

# xf86vmode.h:289
XF86VidModeSetGamma = _lib.XF86VidModeSetGamma
XF86VidModeSetGamma.restype = Bool
XF86VidModeSetGamma.argtypes = [POINTER(Display), c_int,
                                POINTER(XF86VidModeGamma)]

# xf86vmode.h:295
XF86VidModeSetGammaRamp = _lib.XF86VidModeSetGammaRamp
XF86VidModeSetGammaRamp.restype = Bool
XF86VidModeSetGammaRamp.argtypes = [POINTER(Display), c_int, c_int,
...
XF86VidModeGetGammaRamp.argtypes = [POINTER(Display), c_int, c_int,
                                    POINTER(c_ushort), POINTER(c_ushort),
                                    POINTER(c_ushort)]
...
__all__ = ['Bool', 'X_XF86VidModeQueryVersion', 'X_XF86VidModeGetModeLine',
           ...
           'XF86VidModeNumberEvents', 'XF86VidModeBadClock',
           ...
           'XF86VidModeZoomLocked', 'XF86VidModeNumberErrors',
           'XF86VM_READ_PERMISSION',
           'XF86VM_WRITE_PERMISSION', 'XF86VidModeModeLine',
           'XF86VidModeModeInfo',
           'XF86VidModeSyncRange', 'XF86VidModeMonitor', 'Display', 'Window',
           'Time',
