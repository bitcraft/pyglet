...
struct_AVCodec._fields_ = [
    ...
    ('encode', POINTER(
        CFUNCTYPE(c_int, POINTER(AVCodecContext), POINTER(c_uint8), c_int,
                  POINTER(None)))),
    ('close', POINTER(CFUNCTYPE(c_int, POINTER(AVCodecContext)))),
    ('decode', POINTER(
        CFUNCTYPE(c_int, POINTER(AVCodecContext), POINTER(None), POINTER(c_int),
...
# /usr/include/ffmpeg/avcodec.h:1996
AVPaletteControl = struct_AVPaletteControl
...
audio_resample.argtypes = [POINTER(ReSampleContext), POINTER(c_short),
...
av_resample.argtypes = [POINTER(struct_AVResampleContext), POINTER(c_short),
                        POINTER(c_short), POINTER(c_int), c_int, c_int, c_int]
...
av_resample_compensate.argtypes = [POINTER(struct_AVResampleContext), c_int,
                                   c_int]
...
# /usr/include/ffmpeg/avcodec.h:2195
ImgReSampleContext = struct_ImgReSampleContext
...
img_resample_full_init.argtypes = [c_int, c_int, c_int, c_int, c_int, c_int,
                                   c_int, c_int, c_int, c_int, c_int, c_int]

# /usr/include/ffmpeg/avcodec.h:2208
img_resample = _lib.img_resample
img_resample.restype = None
img_resample.argtypes = [POINTER(ImgReSampleContext), POINTER(AVPicture),
                         POINTER(AVPicture)]
...
avpicture_fill.argtypes = [POINTER(AVPicture), POINTER(c_uint8), c_int, c_int,
                           c_int]

# /usr/include/ffmpeg/avcodec.h:2229
avpicture_layout = _lib.avpicture_layout
avpicture_layout.restype = c_int
avpicture_layout.argtypes = [POINTER(AVPicture), c_int, c_int, c_int,
...
avcodec_get_chroma_sub_sample.argtypes = [
...
avcodec_alloc_context.argtypes = list()
...
avcodec_alloc_frame.argtypes = list()
...
avcodec_default_get_buffer.argtypes = [POINTER(AVCodecContext),
                                       POINTER(AVFrame)]
...
avcodec_default_release_buffer.argtypes = [POINTER(AVCodecContext),
                                           POINTER(AVFrame)]
...
avcodec_default_reget_buffer.argtypes = [POINTER(AVCodecContext),
                                         POINTER(AVFrame)]
...
avcodec_align_dimensions.argtypes = [POINTER(AVCodecContext), POINTER(c_int),
                                     POINTER(c_int)]
...
avcodec_default_get_format.argtypes = [POINTER(struct_AVCodecContext),
                                       POINTER(enum_PixelFormat)]
...
avcodec_default_execute.argtypes = [POINTER(AVCodecContext),
                                    CFUNCTYPE(c_int, POINTER(AVCodecContext),
                                              POINTER(None)),
                                    POINTER(POINTER(None)), POINTER(c_int),
                                    c_int]
...
avcodec_decode_audio.argtypes = [POINTER(AVCodecContext), POINTER(c_int16),
...
avcodec_decode_video.argtypes = [POINTER(AVCodecContext), POINTER(AVFrame),
                                 POINTER(c_int), POINTER(c_uint8), c_int]

# /usr/include/ffmpeg/avcodec.h:2315
avcodec_encode_audio = _lib.avcodec_encode_audio
avcodec_encode_audio.restype = c_int
avcodec_encode_audio.argtypes = [POINTER(AVCodecContext), POINTER(c_uint8),
                                 c_int, POINTER(c_short)]

# /usr/include/ffmpeg/avcodec.h:2317
avcodec_encode_video = _lib.avcodec_encode_video
avcodec_encode_video.restype = c_int
avcodec_encode_video.argtypes = [POINTER(AVCodecContext), POINTER(c_uint8),
                                 c_int, POINTER(AVFrame)]
...
avcodec_register_all.argtypes = list()
...
av_reduce.argtypes = [
    POINTER(c_int), POINTER(c_int), c_int64, c_int64, c_int64]
...
# /usr/include/ffmpeg/avcodec.h:2379
AVCodecParserContext = struct_AVCodecParserContext
...
struct_AVCodecParser._fields_ = [
    ...
    ('parser_parse', POINTER(
        CFUNCTYPE(c_int, POINTER(AVCodecParserContext), POINTER(AVCodecContext),
                  POINTER(POINTER(c_uint8)), POINTER(c_int), POINTER(c_uint8),
                  c_int))),
...
av_parser_parse.argtypes = [POINTER(AVCodecParserContext),
                            POINTER(AVCodecContext), POINTER(POINTER(c_uint8)),
                            POINTER(c_int), POINTER(c_uint8), c_int, c_int64,
                            c_int64]
...
img_copy.argtypes = [POINTER(AVPicture), POINTER(AVPicture), c_int, c_int,
                     c_int]
...
av_log_get_level.argtypes = list()
...
__all__ = ['FFMPEG_VERSION_INT', 'LIBAVCODEC_BUILD', 'LIBAVCODEC_VERSION_INT',
           ...
           'FF_MAX_B_FRAMES', 'CODEC_FLAG_QSCALE', 'CODEC_FLAG_4MV',
           'CODEC_FLAG_QPEL',
           ...
           'MB_TYPE_8x8', 'MB_TYPE_INTERLACED', 'MB_TYPE_DIRECT2',
           'MB_TYPE_ACPRED',
           'MB_TYPE_GMC', 'MB_TYPE_SKIP', 'MB_TYPE_P0L0', 'MB_TYPE_P1L0',
           'MB_TYPE_P0L1',
           'MB_TYPE_P1L1', 'MB_TYPE_L0', 'MB_TYPE_L1', 'MB_TYPE_L0L1',
           'MB_TYPE_QUANT',
           'MB_TYPE_CBP', 'AVPanScan', 'FF_QSCALE_TYPE_MPEG1',
           'FF_QSCALE_TYPE_MPEG2',
           'FF_BUFFER_TYPE_INTERNAL', 'FF_BUFFER_TYPE_USER',
           'FF_BUFFER_TYPE_SHARED',
           'FF_BUFFER_TYPE_COPY', 'FF_I_TYPE', 'FF_P_TYPE', 'FF_B_TYPE',
           'FF_S_TYPE',
           'FF_SI_TYPE', 'FF_SP_TYPE', 'FF_BUFFER_HINTS_VALID',
           'FF_BUFFER_HINTS_READABLE', 'FF_BUFFER_HINTS_PRESERVE',
           'FF_BUFFER_HINTS_REUSABLE', 'AVFrame', 'DEFAULT_FRAME_RATE_BASE',
           'AVClass',
           'FF_ASPECT_EXTENDED', 'FF_BUG_AUTODETECT', 'FF_BUG_OLD_MSMPEG4',
           'FF_BUG_XVID_ILACE', 'FF_BUG_UMP4', 'FF_BUG_NO_PADDING',
           'FF_BUG_AMV',
           'FF_BUG_AC_VLC', 'FF_BUG_QPEL_CHROMA', 'FF_BUG_STD_QPEL',
           'FF_BUG_QPEL_CHROMA2', 'FF_BUG_DIRECT_BLOCKSIZE', 'FF_BUG_EDGE',
           'FF_BUG_HPEL_CHROMA', 'FF_BUG_DC_CLIP', 'FF_ER_CAREFULL',
           'FF_ER_COMPLIANT',
           'FF_ER_AGGRESSIVE', 'FF_ER_VERY_AGGRESSIVE', 'FF_DCT_AUTO',
           'FF_DCT_FASTINT',
           'FF_DCT_INT', 'FF_DCT_MMX', 'FF_DCT_MLIB', 'FF_DCT_ALTIVEC',
           'FF_DCT_FAAN',
           'FF_IDCT_AUTO', 'FF_IDCT_INT', 'FF_IDCT_SIMPLE', 'FF_IDCT_SIMPLEMMX',
           'FF_IDCT_LIBMPEG2MMX', 'FF_IDCT_PS2', 'FF_IDCT_MLIB', 'FF_IDCT_ARM',
           'FF_IDCT_ALTIVEC', 'FF_IDCT_SH4', 'FF_IDCT_SIMPLEARM',
           'FF_IDCT_H264',
           'FF_EC_GUESS_MVS', 'FF_EC_DEBLOCK', 'FF_MM_FORCE', 'FF_PRED_LEFT',
           'FF_PRED_PLANE', 'FF_PRED_MEDIAN', 'FF_DEBUG_PICT_INFO',
           'FF_DEBUG_RC',
           'FF_DEBUG_BITSTREAM', 'FF_DEBUG_MB_TYPE', 'FF_DEBUG_QP',
           'FF_DEBUG_MV',
           'FF_DEBUG_DCT_COEFF', 'FF_DEBUG_SKIP', 'FF_DEBUG_STARTCODE',
           'FF_DEBUG_PTS',
           'FF_DEBUG_ER', 'FF_DEBUG_MMCO', 'FF_DEBUG_BUGS', 'FF_DEBUG_VIS_QP',
           'FF_DEBUG_VIS_MB_TYPE', 'FF_DEBUG_VIS_MV_P_FOR',
           'FF_DEBUG_VIS_MV_B_FOR',
           'FF_DEBUG_VIS_MV_B_BACK', 'FF_CMP_SAD', 'FF_CMP_SSE', 'FF_CMP_SATD',
           'FF_CMP_DCT', 'FF_CMP_PSNR', 'FF_CMP_BIT', 'FF_CMP_RD',
           'FF_CMP_ZERO',
           'FF_CMP_VSAD', 'FF_CMP_VSSE', 'FF_CMP_NSSE', 'FF_CMP_W53',
           'FF_CMP_W97',
           'FF_CMP_DCTMAX', 'FF_CMP_CHROMA', 'FF_DTG_AFD_SAME',
           'FF_DTG_AFD_4_3',
           'FF_DTG_AFD_16_9', 'FF_DTG_AFD_14_9', 'FF_DTG_AFD_4_3_SP_14_9',
           'FF_DTG_AFD_16_9_SP_14_9', 'FF_DTG_AFD_SP_4_3',
           'FF_DEFAULT_QUANT_BIAS',
           'FF_LAMBDA_SHIFT', 'FF_LAMBDA_SCALE', 'FF_QP2LAMBDA',
           'FF_LAMBDA_MAX',
           ...
           'FF_OPT_TYPE_RCOVERRIDE', 'FF_OPT_MAX_DEPTH', 'AVOption',
           'avoption_parse',
           'AVCodec', 'AVPicture', 'AVPALETTE_SIZE', 'AVPALETTE_COUNT',
           'AVPaletteControl', 'ReSampleContext', 'audio_resample_init',
           'audio_resample', 'audio_resample_close', 'av_resample_init',
           'av_resample',
           'av_resample_compensate', 'av_resample_close', 'ImgReSampleContext',
           'img_resample_init', 'img_resample_full_init', 'img_resample',
           'img_resample_close', 'avpicture_alloc', 'avpicture_free',
           'avpicture_fill',
           'avpicture_layout', 'avpicture_get_size',
           'avcodec_get_chroma_sub_sample',
           'avcodec_get_pix_fmt_name', 'avcodec_set_dimensions',
           'avcodec_get_pix_fmt',
           'avcodec_pix_fmt_to_codec_tag', 'FF_LOSS_RESOLUTION',
           'FF_LOSS_DEPTH',
           'FF_LOSS_COLORSPACE', 'FF_LOSS_ALPHA', 'FF_LOSS_COLORQUANT',
           'FF_LOSS_CHROMA',
           'avcodec_get_pix_fmt_loss', 'avcodec_find_best_pix_fmt',
           'FF_ALPHA_TRANSP',
           'FF_ALPHA_SEMI_TRANSP', 'img_get_alpha_info', 'img_convert',
           'avpicture_deinterlace', 'avcodec_version', 'avcodec_build',
           'avcodec_init',
           'register_avcodec', 'avcodec_find_encoder',
           ...
           'avcodec_thread_init', 'avcodec_thread_free',
           'avcodec_thread_execute',
           'avcodec_default_execute', 'avcodec_open', 'avcodec_decode_audio',
           'avcodec_decode_video', 'avcodec_parse_frame',
           ...
           'av_parser_close', 'av_malloc', 'av_mallocz', 'av_realloc',
           'av_free',
           'av_strdup', 'av_freep', 'av_fast_realloc', 'av_free_static',
           'av_mallocz_static', 'av_realloc_static', 'is_adx', 'img_copy',
           'AV_LOG_QUIET', 'AV_LOG_ERROR', 'AV_LOG_INFO', 'AV_LOG_DEBUG',
           'av_log',
           'av_vlog', 'av_log_get_level', 'av_log_set_level',
           'av_log_set_callback']
