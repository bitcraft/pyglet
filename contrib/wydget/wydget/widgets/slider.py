...
class SliderBar(Label):
    ...
    def __init__(self, parent, axis, initial, width, height, **kw):
        ...
        super().__init__(parent, str(initial), width=width,
                         height=height, halign='center',
                         rotate=rotate, **kw)
...
class ArrowButton(RepeaterButton):
    ...
    def __init__(self, parent, **kw):
        super().__init__(parent, image=self.arrow, **kw)
